...
public class AdminSupportController {
	...
	public ResponseEntity<?> getFilteredInquiries(
	    ...
	    Page<UserSupport> inquiries = adminSupportService.getFilteredInquiries(pageable, status, category, keyword);
	...
	public ResponseEntity<?> getInquiryById(@PathVariable("inquiryNo") int inquiryNo) {
		...
		Optional<AdminSupportDetailDTO> inquiry = adminSupportService.getInquiryById(inquiryNo);
